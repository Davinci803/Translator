...
//телеграм бот из двух модулей, сам бот и работа с апишкой,бд. Регается, считываешь его гео и отправлять погоду, через определенное время скидывается погода
